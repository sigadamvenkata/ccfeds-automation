  ...
  features: [
    {
      ...
      path: '/products/firefly/features/sticker-generator.html?georouting=off',
    ...
    },
    {
      ...
      path: '/products/firefly/features/background-generator.html?georouting=off',
      data: { file: IMAGE_FILE },
    ...
    },
    {
      ...
      path: '/products/firefly/features/headshot-generator.html?georouting=off',
      data: { file: IMAGE_FILE },
    ...
    },
    {
      ...
      path: '/products/firefly/features/image-to-image.html?georouting=off',
      data: { file: IMAGE_FILE },
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-photo-editor.html?georouting=off',
      data: { file: IMAGE_FILE },
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-cartoon-generator.html?georouting=off',
      data: { file: IMAGE_FILE },
    ...
    },
    {
      ...
      path: '/products/firefly/features/pixel-art-generator.html?georouting=off',
      data: { file: IMAGE_FILE },
