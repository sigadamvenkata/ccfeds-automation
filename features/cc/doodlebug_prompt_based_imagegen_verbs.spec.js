  ...
  features: [
    {
      ...
      path: '/products/firefly/features/ai-art-generator.html?georouting=off',
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-drawing-generator.html?georouting=off',
      data: { prompt: CUSTOM_PROMPT },
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-graphic-design-generator.html?georouting=off',
      data: { prompt: CUSTOM_PROMPT },
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-face-generator.html?georouting=off',
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-human-generator.html?georouting=off',
      data: { prompt: CUSTOM_PROMPT },
    ...
    },
    {
      ...
      path: '/products/firefly/features/ai-anime-generator.html?georouting=off',
      data: { prompt: CUSTOM_PROMPT },
